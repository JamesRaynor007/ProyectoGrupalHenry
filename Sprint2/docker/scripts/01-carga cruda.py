...
def descargar_archivos_de_google_drive(directorio_destino, folder_id):
    creds = service_account.Credentials.from_service_account_file('/app/proyecto-resto-score-f02454a3aee3.json')
...
if __name__ == '__main__':
    # Usar rutas dentro del contenedor
    carpeta_base = '/data'  # Cambia esta línea
